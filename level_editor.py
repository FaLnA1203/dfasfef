...
blob_img = pygame.image.load('spider_1.png')
platform_x_img = pygame.image.load('platform.png')
platform_y_img = pygame.image.load('platform.png')
...
while run:
	...
	if save_button.draw():
		#save level data
		pickle_out = open(f'level{level}_.py', 'wb')
